...
INSERT INTO intelligence.chief_perfil_perguntas (id, chief_id, perguntas, answers, answers_at, answers_enriched_at, created_at)
SELECT id, chief_id, perguntas, answers, answers_at, answers_enriched_at, created_at FROM intel_src.chief_perfil_perguntas;
...
INSERT INTO intelligence.jd_results (id, job_description_id, pipeline_run_id, chief_id, chief_name, iqt_score, aderencia, outreach_subject, outreach_body, outreach_word_count, rank_position, search_origin, scored_at, is_deleted, deleted_at, t2_detail, t3_detail, scoring_method, manual_add_reason, manual_add_reason_note, shadow_rank, shadow_score, shadow_method, rerank_detail)
SELECT id, job_description_id, pipeline_run_id, chief_id, chief_name, iqt_score, aderencia, outreach_subject, outreach_body, outreach_word_count, rank_position, search_origin, scored_at, is_deleted, deleted_at, t2_detail, t3_detail, scoring_method, manual_add_reason, manual_add_reason_note, shadow_rank, shadow_score, shadow_method, rerank_detail FROM intel_src.jd_results;
...
SELECT setval('intelligence.chief_perfil_perguntas_id_seq', COALESCE((SELECT MAX(id) FROM intelligence.chief_perfil_perguntas), 0) + 1, false);
...
ANALYZE intelligence.backtest_jobs;
ANALYZE intelligence.benchmark_market_cache;
ANALYZE intelligence.benchmark_qa;
ANALYZE intelligence.chief_career_history;
ANALYZE intelligence.chief_contextual_qa;
ANALYZE intelligence.chief_enrichment_history;
ANALYZE intelligence.chief_improvement_event;
ANALYZE intelligence.chief_laudo;
ANALYZE intelligence.chief_laudo_modal_state;
ANALYZE intelligence.chief_perfil_perguntas;
ANALYZE intelligence.chief_platform_history;
ANALYZE intelligence.chief_rerank_cache;
ANALYZE intelligence.chief_reverse_matches;
ANALYZE intelligence.chief_reverse_profile;
ANALYZE intelligence.chief_snapshot_before_op;
ANALYZE intelligence.chief_stimulus_event;
ANALYZE intelligence.deal_enrichment_jobs;
ANALYZE intelligence.deal_enrichments;
ANALYZE intelligence.deal_sales_ops;
ANALYZE intelligence.governance_conflicts;
ANALYZE intelligence.ingestion_logs;
ANALYZE intelligence.iqp_snapshots;
...
ANALYZE intelligence.novo_funil_pipedrive;
ANALYZE intelligence.pipedrive_write_log;
ANALYZE intelligence.pipeline_runs;
ANALYZE intelligence.platform_sync_state;
ANALYZE intelligence.system_prompts;
ANALYZE intelligence.ui_access_grant;
ANALYZE intelligence.uploaded_files;
ANALYZE intelligence.user_activity_log;
ANALYZE intelligence.user_favorites;
ANALYZE intelligence.users;
ANALYZE intelligence.chief_embeddings;
ANALYZE intelligence.chief_field_history;
ANALYZE intelligence.job_descriptions;
ANALYZE intelligence.job_embeddings;
ANALYZE intelligence.jd_briefing_embeddings;
ANALYZE intelligence.jd_extracted_metadata;
ANALYZE intelligence.jd_results;
COMMIT;
